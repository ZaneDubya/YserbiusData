...
namespace XPT.Legacy.Maps {
    class YserMap26 : AMapScripted {
        ...
        private void FnDUNGEON_03(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: TeleportParty(player, 0x36, 0x02, 0x40, 0x02, type);
            L002B: return; // RETURN;
        }
        ...
        private void FnBDOORCGC_0C(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0014: ShowMessage(player, doMsgs, String0586); // With a massive effort, you manage to force the door open.
            L0021: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x01);
            L003F: goto L004E;
            L0041: ShowMessage(player, doMsgs, String05C0); // The door is stuck and will not open.
            L004E: return; // RETURN;
        }
        ...
        private void FnTXTPHNX_12(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L008B: goto L00A7;
            L008D: ShowMessage(player, doMsgs, String0781); // You hear the sound of rushing water behind the wall.
            L009A: ShowMessage(player, doMsgs, String07B6); // You also hear muffled roars.
            L00A7: return; // RETURN;
        }
        ...
        private void FnTOELVES_1B(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: TeleportParty(player, 0x37, 0x01, 0x1A, 0x03, type);
            L002B: return; // RETURN;
        }
        ...
        private void FnPHOEGURD_1C(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L004C: goto L0097;
            L004E: ShowMessage(player, doMsgs, String088C); // 'I am the Guardian of the Phoenix.  That you have passed my Dragon Guards is proof of your courage.
        ...
        private void FnTXTBAZZA_1D(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowMessage(player, doMsgs, String099C); // A frightened Halfling Cleric hides in the shadows.
            L001D: ShowMessage(player, doMsgs, String09CF); // 'You must do something about these trolls.  They're everywhere.'
            L002A: return; // RETURN;
        }
        ...
        private void FnTXTBAZZB_1E(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowMessage(player, doMsgs, String0A10); // An exhausted Dwarf Knight hides in a large barrel.
            L001D: ShowMessage(player, doMsgs, String0A43); // 'Hail!  I welcome your help.  These trolls have been giving me fits.'
            L002A: return; // RETURN;
        }
        ...
        private void FnTXTBAZZC_1F(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0000: // BEGIN;
            L0003: ShowPortrait(player, 0x002D);
            L0010: ShowMessage(player, doMsgs, String0A89); // A Gnome Wizard suddenly appears.
            L001D: ShowMessage(player, doMsgs, String0AAA); // 'Past the CastleGates and past the Elves, you will find a place where the blue light of the sky meets the underworld below.'
            L002A: return; // RETURN;
        }
        ...
        private void FnTXTBAZZD_20(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowMessage(player, doMsgs, String0B27); // An Elf Ranger is delighted at your presense.
            L001D: ShowMessage(player, doMsgs, String0B54); // 'I got clobbered by Andreas, the Earth Elemental!  I wish you luck in your adventurers.'
            L002A: return; // RETURN;
        }
        ...
        private void FnPHOEREW_21(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0061: goto L0070;
            L0063: ShowMessage(player, doMsgs, String0BDB); // Nothing happens.
            L0070: return; // RETURN;
        }
        ...
        private void FnMYSTICS_24(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowMessage(player, doMsgs, String0BEC); // A small band of gypsies has formed camp in an old bazaar stall.
            L001D: ShowMessage(player, doMsgs, String0C2C); // A young gypsy stares at you, gestures you closer, and whispers..
            L002A: ShowMessage(player, doMsgs, String0C6D); // 'It is written on the Lava Walls that a Hero will someday reach the end of the rainbow and confront time.'
            L0037: ShowMessage(player, doMsgs, String0CD8); // He pauses, then says, 'Go now, before more Trolls come!  Go!' 
            L0044: return; // RETURN;
        }
        ...
        private void FnFNTNBAZZ_25(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L006B: ShowMessage(player, doMsgs, String0D4E); // You gain the skill of Rune Reading!
            L0078: goto L0118;
            L007B: RefreshCompareFlags(GetSkillLevel(player, 0x16));
            L0089: if (JumpNotEqual) goto L00AB;
            L008B: SetSkillLevel(player, 0x16, 0x01);
            L009C: ShowMessage(player, doMsgs, String0D72); // You gain the Channel skill!
            L00A9: goto L0118;
            L00AB: RefreshCompareFlags(GetSkillLevel(player, 0x15));
            L00B9: if (JumpNotEqual) goto L00DB;
            L00BB: SetSkillLevel(player, 0x15, 0x01);
            L00CC: ShowMessage(player, doMsgs, String0D8E); // You gain the Staff skill!
            L00D9: goto L0118;
            L00DB: RefreshCompareFlags(GetSkillLevel(player, 0x17));
            L00E9: if (JumpNotEqual) goto L010B;
            L00EB: SetSkillLevel(player, 0x17, 0x01);
            L00FC: ShowMessage(player, doMsgs, String0DA8); // You gain the Deep Trance skill!
            L0109: goto L0118;
            L010B: ShowMessage(player, doMsgs, String0DC8); // Nothing happens.
            L0118: goto L0127;
            L011A: ShowMessage(player, doMsgs, String0DD9); // The purple waters of the ElfFoot Fountain slip through your fingers before you can wet your lips.
            L0127: return; // RETURN;
        }
        ...
        private void FnTXTLOOKB_2A(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowRunes(player, doMsgs, String0E5F); // 'We, the Dwarves of NottiRock, seek brightly colored metals to forge magnificent treasures.'
            L001D: return; // RETURN;
        }
        ...
        private void FnFNTNLOOK_2B(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L006B: ShowMessage(player, doMsgs, String0EF6); // You gain the skill of Stamina!
            L0078: goto L0118;
            L007B: RefreshCompareFlags(GetSkillLevel(player, 0x0A));
            L0089: if (JumpNotEqual) goto L00AB;
            L008B: SetSkillLevel(player, 0x0A, 0x02);
            L009C: ShowMessage(player, doMsgs, String0F15); // You gain the skill of Furtiveness!
            L00A9: goto L0118;
            L00AB: RefreshCompareFlags(GetSkillLevel(player, 0x0B));
            L00B9: if (JumpNotEqual) goto L00DB;
            L00BB: SetSkillLevel(player, 0x0B, 0x02);
            L00CC: ShowMessage(player, doMsgs, String0F38); // You gain the skill of Reading Tracks!
            L00D9: goto L0118;
            L00DB: RefreshCompareFlags(GetSkillLevel(player, 0x08));
            L00E9: if (JumpNotEqual) goto L010B;
            L00EB: SetSkillLevel(player, 0x08, 0x02);
            L00FC: ShowMessage(player, doMsgs, String0F5E); // You gain the skill of Archery!
            L0109: goto L0118;
            L010B: ShowMessage(player, doMsgs, String0F7D); // The waters are refreshing, but not enlightening!
            L0118: return; // RETURN;
        }
        ...
        private void FnTXTCSTLA_35(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowMessage(player, doMsgs, String0FCD); // 'The runes seem to spell names.  That is the way to Arnakkian.'
            L001D: return; // RETURN;
        }
        ...
        private void FnTXTCSTLB_36(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0000: // BEGIN;
            L0003: ShowPortrait(player, 0x0016);
            L0010: ShowMessage(player, doMsgs, String100D); // A Human Barbarian belches, then looks up at you.
            L001D: ShowMessage(player, doMsgs, String103E); // 'Andreas built a great pit. Two.'
            L002A: ShowMessage(player, doMsgs, String1060); // Holding up three fingers, he repeats...
            L0037: ShowMessage(player, doMsgs, String1088); // 'Two.  Must need two to cross.'
            L0044: return; // RETURN;
        }
        ...
        private void FnFNTNHEAL_37(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0021: ShowMessage(player, doMsgs, String10A8); // DayFrost Fountain restores your Health.
            L002E: return; // RETURN;
        }
        ...
        private void FnFNTNMANA_38(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L001D: ShowMessage(player, doMsgs, String10D0); // NightFrost Fountain renews your Mana.
            L002A: return; // RETURN;
        }
        ...
        private void FnTXTCSTLC_3B(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowMessage(player, doMsgs, String10F6); // A Phantasm appears...
            L001D: ShowMessage(player, doMsgs, String110C); // 'Dare time?  Yes?  Ah, adventurers should not challenge En-Li-Kil!'
            L002A: ShowMessage(player, doMsgs, String1150); // The Phantasm drains your life energies.
