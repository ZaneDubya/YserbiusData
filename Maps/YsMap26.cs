...
namespace XPT.Legacy.Maps {
    class YserMap26 : AMapScripted {
        ...
        private void FnLAVA_01(ServerPlayer player, bool isForwardMove) {
            ...
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String03FC); // You stumble into the lava river and die.
        ...
        private void FnDUNGEON_03(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0425); // This gate leads to the entrance of Arnakkian's Arena.
        ...
        private void FnTXTTEMPS_05(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String045B); // Of all the winds, the TEMPEST is the most violent and dangerous.
            L0010: return; // RETURN;
        }
        ...
        private void FnTXTHEAVN_06(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String049C); // Enter HEAVEN'S FURY if you must.  It is here Voranti cursed the winds.
            L0010: return; // RETURN;
        }
        ...
        private void FnTXTCSTLG_07(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String04E3); // A doorway leads to the town of Castlegate, a village just outside Arnakkian's Castle.
            L0010: return; // RETURN;
        }
        ...
        private void FnTXTLOOKO_09(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0539); // It is rumored that a band of dwarves once lived behind the doors of LookOut.
            L0010: return; // RETURN;
        }
        ...
        private void FnBDOORCGC_0C(ServerPlayer player, bool isForwardMove) {
            ...
            L0014: ShowMessage(player, isForwardMove, String0586); // With a massive effort, you manage to force the door open.
            L0021: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x01);
            L003F: goto L004E;
            L0041: ShowMessage(player, isForwardMove, String05C0); // The door is stuck and will not open.
            L004E: return; // RETURN;
        }
        ...
        private void FnRAPID_10(ServerPlayer player, bool isForwardMove) {
            ...
            L0018: ShowMessage(player, isForwardMove, String05E5); // A plaque reads..
            L0025: ShowMessage(player, isForwardMove, String05F6); // 'Thanks to the gracious generosity of the Mage Council, the survivors of the Arnakkian disaster hereby proclaim a new teleport to the top.'
        ...
        private void FnRIVER_11(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0682); // Fighting the raging River of Eternity taps your life energy.
        ...
        private void FnTXTPHNX_12(ServerPlayer player, bool isForwardMove) {
            ...
            L0018: ShowMessage(player, isForwardMove, String06CE); // The Phoenix is being reborn and may not be disturbed.
            L0025: goto L00A7;
            L0028: ax = IsFlagOn(player, FlagTypeDungeon, FlagLabryinthIVPhoenixReborn);
            L003B: if (JumpEqual) goto L008D;
            L003D: ShowMessage(player, isForwardMove, String0704); // Ahead, bound by the River of Eternity, is the shadow of the Phoenix Firebird. 
            L004A: ShowMessage(player, isForwardMove, String0753); // The raging waters of the river look daunting.
            L0057: SetWallPassable(player, GetCurrentTile(player), 0x02, 0x01);
            L0071: SetWallItem(player, 0x01, GetCurrentTile(player), 0x02);
            L008B: goto L00A7;
            L008D: ShowMessage(player, isForwardMove, String0781); // You hear the sound of rushing water behind the wall.
            L009A: ShowMessage(player, isForwardMove, String07B6); // You also hear muffled roars.
            L00A7: return; // RETURN;
        }
        ...
        private void FnTOELVES_1B(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String07D3); // Loose rocks tumble away, revealing a narrow passageway down.
        ...
        private void FnPHOEGURD_1C(ServerPlayer player, bool isForwardMove) {
            ...
            L0010: ShowMessage(player, isForwardMove, String0810); // A Gnome Wizard greets you.
            L001D: ax = IsFlagOn(player, FlagTypeDungeon, FlagLabryinthIVPhoenixReborn1);
            L0030: if (JumpEqual) goto L004E;
            L0032: ShowMessage(player, isForwardMove, String082B); // 'Thank you for helping my master the Phoenix be reborn.
            L003F: ShowMessage(player, isForwardMove, String0863); // The Phoenix may no longer be disturbed.'
            L004C: goto L0097;
            L004E: ShowMessage(player, isForwardMove, String088C); // 'I am the Guardian of the Phoenix.  That you have passed my Dragon Guards is proof of your courage.
            L005B: ShowMessage(player, isForwardMove, String08F0); // The way is now clear for you to meet the Phoenix.
            L0068: ShowMessage(player, isForwardMove, String0922); // It is time for the Phoenix to die and so be reborn from its own ashes.
            L0075: ShowMessage(player, isForwardMove, String0969); // Go!  Let the glorious Phoenix die and be renewed!'
        ...
        private void FnTXTBAZZA_1D(ServerPlayer player, bool isForwardMove) {
            ...
            L0010: ShowMessage(player, isForwardMove, String099C); // A frightened Halfling Cleric hides in the shadows.
            L001D: ShowMessage(player, isForwardMove, String09CF); // 'You must do something about these trolls.  They're everywhere.'
            L002A: return; // RETURN;
        }
        ...
        private void FnTXTBAZZB_1E(ServerPlayer player, bool isForwardMove) {
            ...
            L0010: ShowMessage(player, isForwardMove, String0A10); // An exhausted Dwarf Knight hides in a large barrel.
            L001D: ShowMessage(player, isForwardMove, String0A43); // 'Hail!  I welcome your help.  These trolls have been giving me fits.'
            L002A: return; // RETURN;
        }
        ...
        private void FnTXTBAZZC_1F(ServerPlayer player, bool isForwardMove) {
            ...
            L0000: // BEGIN;
            L0003: ShowPortrait(player, 0x002D);
            L0010: ShowMessage(player, isForwardMove, String0A89); // A Gnome Wizard suddenly appears.
            L001D: ShowMessage(player, isForwardMove, String0AAA); // 'Past the CastleGates and past the Elves, you will find a place where the blue light of the sky meets the underworld below.'
            L002A: return; // RETURN;
        }
        ...
        private void FnTXTBAZZD_20(ServerPlayer player, bool isForwardMove) {
            ...
            L0010: ShowMessage(player, isForwardMove, String0B27); // An Elf Ranger is delighted at your presense.
            L001D: ShowMessage(player, isForwardMove, String0B54); // 'I got clobbered by Andreas, the Earth Elemental!  I wish you luck in your adventurers.'
            L002A: return; // RETURN;
        }
        ...
        private void FnPHOEREW_21(ServerPlayer player, bool isForwardMove) {
            ...
            L0054: ShowMessage(player, isForwardMove, String0BAD); // You feel a sudden increase in your Dexterity.
            L0061: goto L0070;
            L0063: ShowMessage(player, isForwardMove, String0BDB); // Nothing happens.
            L0070: return; // RETURN;
        }
        ...
        private void FnMYSTICS_24(ServerPlayer player, bool isForwardMove) {
            ...
            L0010: ShowMessage(player, isForwardMove, String0BEC); // A small band of gypsies has formed camp in an old bazaar stall.
            L001D: ShowMessage(player, isForwardMove, String0C2C); // A young gypsy stares at you, gestures you closer, and whispers..
            L002A: ShowMessage(player, isForwardMove, String0C6D); // 'It is written on the Lava Walls that a Hero will someday reach the end of the rainbow and confront time.'
            L0037: ShowMessage(player, isForwardMove, String0CD8); // He pauses, then says, 'Go now, before more Trolls come!  Go!' 
            L0044: return; // RETURN;
        }
        ...
        private void FnFNTNBAZZ_25(ServerPlayer player, bool isForwardMove) {
            ...
            L003D: ShowMessage(player, isForwardMove, String0D17); // You sip the cool purple waters of the ElfFoot Fountain
            L004A: RefreshCompareFlags(GetSkillLevel(player, 0x14));
            L0058: if (JumpNotEqual) goto L007B;
            L005A: SetSkillLevel(player, 0x14, 0x01);
            L006B: ShowMessage(player, isForwardMove, String0D4E); // You gain the skill of Rune Reading!
            L0078: goto L0118;
            L007B: RefreshCompareFlags(GetSkillLevel(player, 0x16));
            L0089: if (JumpNotEqual) goto L00AB;
            L008B: SetSkillLevel(player, 0x16, 0x01);
            L009C: ShowMessage(player, isForwardMove, String0D72); // You gain the Channel skill!
            L00A9: goto L0118;
            L00AB: RefreshCompareFlags(GetSkillLevel(player, 0x15));
            L00B9: if (JumpNotEqual) goto L00DB;
            L00BB: SetSkillLevel(player, 0x15, 0x01);
            L00CC: ShowMessage(player, isForwardMove, String0D8E); // You gain the Staff skill!
            L00D9: goto L0118;
            L00DB: RefreshCompareFlags(GetSkillLevel(player, 0x17));
            L00E9: if (JumpNotEqual) goto L010B;
            L00EB: SetSkillLevel(player, 0x17, 0x01);
            L00FC: ShowMessage(player, isForwardMove, String0DA8); // You gain the Deep Trance skill!
            L0109: goto L0118;
            L010B: ShowMessage(player, isForwardMove, String0DC8); // Nothing happens.
            L0118: goto L0127;
            L011A: ShowMessage(player, isForwardMove, String0DD9); // The purple waters of the ElfFoot Fountain slip through your fingers before you can wet your lips.
            L0127: return; // RETURN;
        }
        ...
        private void FnTXTLOOKB_2A(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0E3B); // An inscription on the wall reads...
        ...
        private void FnFNTNLOOK_2B(ServerPlayer player, bool isForwardMove) {
            ...
            L0010: ShowMessage(player, isForwardMove, String0EBC); // Ranger banners decorate the woodwork of Lookout Fountain.
            ...
            L006B: ShowMessage(player, isForwardMove, String0EF6); // You gain the skill of Stamina!
            L0078: goto L0118;
            L007B: RefreshCompareFlags(GetSkillLevel(player, 0x0A));
            L0089: if (JumpNotEqual) goto L00AB;
            L008B: SetSkillLevel(player, 0x0A, 0x02);
            L009C: ShowMessage(player, isForwardMove, String0F15); // You gain the skill of Furtiveness!
            L00A9: goto L0118;
            L00AB: RefreshCompareFlags(GetSkillLevel(player, 0x0B));
            L00B9: if (JumpNotEqual) goto L00DB;
            L00BB: SetSkillLevel(player, 0x0B, 0x02);
            L00CC: ShowMessage(player, isForwardMove, String0F38); // You gain the skill of Reading Tracks!
            L00D9: goto L0118;
            L00DB: RefreshCompareFlags(GetSkillLevel(player, 0x08));
            L00E9: if (JumpNotEqual) goto L010B;
            L00EB: SetSkillLevel(player, 0x08, 0x02);
            L00FC: ShowMessage(player, isForwardMove, String0F5E); // You gain the skill of Archery!
            L0109: goto L0118;
            L010B: ShowMessage(player, isForwardMove, String0F7D); // The waters are refreshing, but not enlightening!
            L0118: return; // RETURN;
        }
        ...
        private void FnTXTCSTLA_35(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0FAE); // A message is etched on wall...
            L0010: ShowMessage(player, isForwardMove, String0FCD); // 'The runes seem to spell names.  That is the way to Arnakkian.'
            L001D: return; // RETURN;
        }
        ...
        private void FnTXTCSTLB_36(ServerPlayer player, bool isForwardMove) {
            ...
            L0000: // BEGIN;
            L0003: ShowPortrait(player, 0x0016);
            L0010: ShowMessage(player, isForwardMove, String100D); // A Human Barbarian belches, then looks up at you.
            L001D: ShowMessage(player, isForwardMove, String103E); // 'Andreas built a great pit. Two.'
            L002A: ShowMessage(player, isForwardMove, String1060); // Holding up three fingers, he repeats...
            L0037: ShowMessage(player, isForwardMove, String1088); // 'Two.  Must need two to cross.'
            L0044: return; // RETURN;
        }
        ...
        private void FnFNTNHEAL_37(ServerPlayer player, bool isForwardMove) {
            ...
            L0021: ShowMessage(player, isForwardMove, String10A8); // DayFrost Fountain restores your Health.
            L002E: return; // RETURN;
        }
        ...
        private void FnFNTNMANA_38(ServerPlayer player, bool isForwardMove) {
            ...
            L001D: ShowMessage(player, isForwardMove, String10D0); // NightFrost Fountain renews your Mana.
            L002A: return; // RETURN;
        }
        ...
        private void FnTXTCSTLC_3B(ServerPlayer player, bool isForwardMove) {
            ...
            L0010: ShowMessage(player, isForwardMove, String10F6); // A Phantasm appears...
            L001D: ShowMessage(player, isForwardMove, String110C); // 'Dare time?  Yes?  Ah, adventurers should not challenge En-Li-Kil!'
            L002A: ShowMessage(player, isForwardMove, String1150); // The Phantasm drains your life energies.
