...
namespace XPT.Legacy.Maps {
    class YserMap30 : AMapScripted {
        ...
        private void FnSECDOORA_0C(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0014: ax = HasUsedItem(player, type, ref doMsgs, 0xBE, 0xBE);
            L0027: if (JumpEqual) goto L0072;
            L0029: ShowMessage(player, doMsgs, String059D); // You locate a hidden door in the wall.
        ...
        private void FnSECDOORB_0D(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0014: ax = HasUsedItem(player, type, ref doMsgs, 0xBE, 0xBE);
            L0027: if (JumpEqual) goto L0072;
            L0029: ShowMessage(player, doMsgs, String05C3); // You locate a hidden door in the wall.
            L0036: SetWallItem(player, 0x01, GetCurrentTile(player), GetFacing(player));
            L0054: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x01);
            L0072: return; // RETURN;
        }
        ...
        private void FnSECDOORC_0E(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0029: ShowMessage(player, doMsgs, String05E9); // You locate a hidden door in the wall.
            L0036: SetWallItem(player, 0x01, GetCurrentTile(player), GetFacing(player));
            L0054: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x01);
            L0072: goto L0091;
        ...
        private void FnSUNBEAM_14(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L002D: ShowMessage(player, doMsgs, String063B); // The leader steps forward, his eyes fixed on the blue metal.
        ...
        private void FnHEALFA_27(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0021: ShowMessage(player, doMsgs, String09CA); // Your full health is restored by the ancient waters of RoundBrook Fountain.
            L002E: return; // RETURN;
        }
        ...
        private void FnHEALFB_28(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0003: ShowPortrait(player, 0x0042);
            L0010: HealPlayer(player, (ushort)GetMaxHits(player));
            L0021: ShowMessage(player, doMsgs, String0A15); // You feel all your health restored after sipping from JasperStone Fountain.
            L002E: return; // RETURN;
        }
        ...
        private void FnHEALFC_29(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0003: ShowPortrait(player, 0x0042);
            L0010: HealPlayer(player, (ushort)GetMaxHits(player));
            L0021: ShowMessage(player, doMsgs, String0A60); // The waters of RockyFlat Fountain restores your health.
            L002E: return; // RETURN;
        }
        ...
        private void FnMANAFA_2A(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L001D: ShowMessage(player, doMsgs, String0A97); // Your mana is recharged by drinking the magical waters of Omar Fountain.
            L002A: return; // RETURN;
        }
        ...
        private void FnMANAFB_2B(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowMessage(player, doMsgs, String0ADF); // Your magical powers are recharged by the heated steams of Venivor Geyser.
            L001D: return; // RETURN;
        }
        ...
        private void FnMANAFC_2C(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0000: // BEGIN;
            L0003: AddMana(player, 0x07D0);
            L0010: ShowMessage(player, doMsgs, String0B29); // Your mana is increased in a whirlpool at the edge of the river.
            L001D: return; // RETURN;
        }
        ...
        private void FnCLUEA_2D(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowRunes(player, doMsgs, String0B90); // The Tapestry of the Moons requires a spectrum of color to open.
            L001D: return; // RETURN;
        }
        ...
        private void FnCLUEB_2E(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowMessage(player, doMsgs, String0C0A); // 'I am Zephyr.  
            L001D: ShowMessage(player, doMsgs, String0C1A); // 'Only the FlexSword can bend against the Wind Elemental's gail.'
            L002A: return; // RETURN;
        }
        ...
        private void FnCLUEC_2F(ServerPlayer player, MapEventType type, bool doMsgs) {
            ...
            L0010: ShowRunes(player, doMsgs, String0C87); // It is said that the Dwarves can build magnificent creations and vessels out of golden threads.
            L001D: return; // RETURN;
        }
