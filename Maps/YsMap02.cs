...
namespace XPT.Legacy.Maps {
    class YserMap02 : AMapScripted {
        ...
        private void FnKEYDOOR_03(ServerPlayer player, bool isForwardMove) {
            ...
            L0018: ShowMessage(player, isForwardMove, String03FC); // Cleowyn's Key has unlocked the door.
            ...
            L0061: goto L008D;
            L0063: ShowMessage(player, isForwardMove, String0421); // The door is locked.  Something special is needed to open this door.
        ...
        private void FnKEYMESSG_04(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0465); // The tapestry shows a message in runes...
        ...
        private void FnLKPKDOOR_05(ServerPlayer player, bool isForwardMove) {
            ...
            L0016: if (JumpNotEqual) goto L0063;
            L0018: ShowMessage(player, isForwardMove, String04B8); // Cleowyn's Lockpick has unlocked the door.
            L0025: SetWallItem(player, 0x01, GetCurrentTile(player), GetFacing(player));
            L0043: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x01);
            L0061: goto L008D;
            L0063: ShowMessage(player, isForwardMove, String04E2); // The door is locked.
            L0070: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x00);
            L008D: return; // RETURN;
        }
        ...
        private void FnLKPKMESG_06(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String04F6); // There are runes on the tapestry...
        ...
        private void FnSTRDOOR_07(ServerPlayer player, bool isForwardMove) {
            ...
            L0016: if (JumpNotEqual) goto L0063;
            L0018: ShowMessage(player, isForwardMove, String0546); // The door has been forced open.
            L0025: SetWallItem(player, 0x01, GetCurrentTile(player), GetFacing(player));
            L0043: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x01);
            L0061: goto L008D;
            L0063: ShowMessage(player, isForwardMove, String0565); // The door is currently impassable.
            L0070: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x00);
            L008D: return; // RETURN;
        }
        ...
        private void FnSTRMESSG_08(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0587); // The tapestry has runes...
        ...
        private void FnGOLDENC_09(ServerPlayer player, bool isForwardMove) {
            ...
            L0019: ShowMessage(player, isForwardMove, String05D1); // Aside from angry Rogues, the room is empty.
            ...
            L007B: ShowMessage(player, isForwardMove, String05FD); // A Rogue drops gold coins on the floor as the villains draw their weapons.
        ...
        private void FnPALKEYEN_0B(ServerPlayer player, bool isForwardMove) {
            ...
            L0033: ShowMessage(player, isForwardMove, String0647); // The room is empty. Almost.
            L0040: goto L006E;
            L0042: AddTreasure(player, 0x03E8, 0x00, 0x00, 0x00, 0x00, 0xD9);
            L0061: ShowMessage(player, isForwardMove, String0662); // A Key in the shape of a Palace lies in a corner, if you can get to it.
        ...
        private void FnLOWMNSTR_0D(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String06A9); // You encounter Rogues.
            ...
            L0041: ShowMessage(player, isForwardMove, String06BF); // If you are skilled enough, you may find teleports that speed your way to various levels of this dungeon.
            L004E: goto L008A;
            L0050: ShowMessage(player, isForwardMove, String0728); // The Rogues snarl at you.
            L005D: ShowMessage(player, isForwardMove, String0741); // They attack!
        ...
        private void FnMESSAGEA_11(ServerPlayer player, bool isForwardMove) {
            ...
            L0016: ShowMessage(player, isForwardMove, String074E); // This gateway leads to THE MINES.
            L0023: return; // RETURN;
        }
        ...
        private void FnMESSAGEB_12(ServerPlayer player, bool isForwardMove) {
            ...
            L0000: // BEGIN;
            L0003: SetFlag(player, FlagTypeDungeon, FlagVestibuleUnlockType, 0x00);
            L0016: ShowMessage(player, isForwardMove, String076F); // This gateway leads to THE HALL OF DOORS.
            L0023: return; // RETURN;
        }
        ...
        private void FnTELEMESS_13(ServerPlayer player, bool isForwardMove) {
            ...
            L0017: ShowMessage(player, isForwardMove, String0798); // There is a teleport to the north.
            L0024: return; // RETURN;
        }
        ...
        private void FnSTRSMESS_14(ServerPlayer player, bool isForwardMove) {
            ...
            L0017: ShowMessage(player, isForwardMove, String07BA); // There are stairs to the west through the gateway.
            L0024: return; // RETURN;
        }
        ...
        private void FnREGDOOR_16(ServerPlayer player, bool isForwardMove) {
            ...
            L0016: if (JumpNotEqual) goto L0063;
            L0018: ShowMessage(player, isForwardMove, String07EC); // As you open the door, you hear locks click throughout the dungeon.
            L0025: SetWallItem(player, 0x01, GetCurrentTile(player), GetFacing(player));
            L0043: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x01);
            L0061: goto L008D;
            L0063: ShowMessage(player, isForwardMove, String082F); // The door is currently impassable.
            L0070: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x00);
            L008D: return; // RETURN;
        }
        ...
        private void FnNPCCHATA_17(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0851); // You encounter an Elf Ranger.
            L0010: ShowPortrait(player, 0x001F);
            L001D: Compare(GetRandom(0x000F), 0x000B);
            L002D: if (JumpAbove) goto L003E;
            L002F: ShowMessage(player, isForwardMove, String086E); // You must solve the mystery of the linked Vestibule doors to continue farther down into the dungeon.
            L003C: goto L004B;
            L003E: ShowMessage(player, isForwardMove, String08D2); // The Elf Ranger decides you are not worthy of his time and leaves.
            L004B: return; // RETURN;
        }
        ...
        private void FnNPCCHATB_18(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0914); // You encounter a Human Wizard.
            L0010: ShowPortrait(player, 0x002B);
            L001D: Compare(GetRandom(0x000F), 0x0009);
            L002D: if (JumpAbove) goto L003E;
            L002F: ShowMessage(player, isForwardMove, String0932); // Centuries ago, Twinion was a thriving port town, ruled by the Galabryan dynasty. The kings welcomed all races and Guilds to the island. When the volcano Yserbius erupted, it almost buried Twinion under lava. If only we could find some way off this island!
            L003C: goto L004B;
            L003E: ShowMessage(player, isForwardMove, String0A32); // The Human Wizard falls into a deep trance and refuses to talk.
            L004B: return; // RETURN;
        }
        ...
        private void FnNPCCHATC_19(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0A71); // You encounter a Gremlin Thief.
            L0010: ShowPortrait(player, 0x0026);
            L001D: Compare(GetRandom(0x000F), 0x000A);
            L002D: if (JumpAbove) goto L003E;
            L002F: ShowMessage(player, isForwardMove, String0A90); // King Cleowyn created a clever maze of squares to discourage thieves and invaders. Mind you, no invaders ever thought Twinion rich enough to be worth their effort.
            L003C: goto L004B;
            L003E: ShowMessage(player, isForwardMove, String0B33); // The Gremlin Thief slips into a shadow and disappears.
            L004B: return; // RETURN;
        }
        ...
        private void FnNPCCHATD_1A(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0B69); // You encounter an Orc Knight.
            L0010: ShowPortrait(player, 0x001A);
            L001D: Compare(GetRandom(0x000F), 0x0008);
            L002D: if (JumpAbove) goto L003E;
            L002F: ShowMessage(player, isForwardMove, String0B86); // The richness of fine armor and weapons in this dungeon baffles me. I've heard rumors that skilled dwarfs once crafted such armory, but the rogue dwarfs you encounter nowadays have no talent for such expert metallurgy.
            L003C: goto L004B;
            L003E: ShowMessage(player, isForwardMove, String0C60); // The Orc Knight smiles politely and shoos you away.
            L004B: return; // RETURN;
        }
        ...
        private void FnNPCCHATE_1B(ServerPlayer player, bool isForwardMove) {
            int ax = 0, bx = 0, cx = 0, dx = 0, si = 0, di = 0, tmp = 0;
            L0000: // BEGIN;
            L0003: ShowMessage(player, isForwardMove, String0C93); // You encounter an Elf Cleric.
            L0010: ShowPortrait(player, 0x0027);
            L001D: Compare(GetRandom(0x000F), 0x0008);
            L002D: if (JumpAbove) goto L003E;
            L002F: ShowMessage(player, isForwardMove, String0CB0); // I have visited King Cleowyn's throne room, and what a disappointment it was. Not much treasure there and too many dead things. Perhaps I missed something.
            L003C: goto L004B;
            L003E: ShowMessage(player, isForwardMove, String0D4B); // The Elf Cleric is too engrossed in his prayers to talk with you.
            L004B: return; // RETURN;
        }
        ...
        private void FnKEYDRA_1C(ServerPlayer player, bool isForwardMove) {
            ...
            L0027: ShowMessage(player, isForwardMove, String0D8C); // Cleowyn's Key unlocks the door.
            ...
            L0070: goto L009C;
            L0072: ShowMessage(player, isForwardMove, String0DAC); // The door is locked.
        ...
        private void FnLKPKDRA_1D(ServerPlayer player, bool isForwardMove) {
            ...
            L0027: ShowMessage(player, isForwardMove, String0DC0); // Cleowyn's Lockpick has unlocked the door.
            L0034: SetWallItem(player, 0x01, GetCurrentTile(player), GetFacing(player));
            L0052: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x01);
            L0070: goto L009C;
            L0072: ShowMessage(player, isForwardMove, String0DEA); // The door is locked.  It looks like something special is needed to open this door.
            L007F: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x00);
            L009C: return; // RETURN;
        }
        ...
        private void FnSTRNGDRA_1E(ServerPlayer player, bool isForwardMove) {
            ...
            L0028: ShowMessage(player, isForwardMove, String0E3C); // You manage to force open the door.
            ...
            L0071: goto L009D;
            L0073: ShowMessage(player, isForwardMove, String0E5F); // The door is currently impassable.
        ...
        private void FnREGDORA_1F(ServerPlayer player, bool isForwardMove) {
            ...
            L0040: ShowMessage(player, isForwardMove, String0E81); // As you open the door, you hear locks click throughout the dungeon.
            ...
            L0089: goto L00B5;
            L008B: ShowMessage(player, isForwardMove, String0EC4); // The door is currently impassable.
