namespace XPT.Twinion.Maps {
    class TwMap32 : TwMap {
        ...
        char alchemyStr = "Choronzar hopes to advance his position among the gods by magical means. To this end he is attempting an alchemical Binding Ritual on the mortal spirits his minions kidnap. Thus far success -- in the form of the correct formula -- has eluded him.";;
        char choronzarStr = "Choronzar is a trickster deity. Although he is a lesser light among the evil pantheon, his cunning and ambition far exceed the comprehension of his more powerful brethren, many of whom consider him insane and hence relatively harmless.";;
        char naomiStr = "Princess Naomi was abducted from her world by Shadax, who was attracted by the purity of her spirit. Choronzar fell in love with her and spared her from his experiments in the hope that she would return his affections. She has not.";;
        char dissStr = "The cauldron boils up as the bar dissolves.";;
        char brackStr = "The liquid in the cauldron turns a brackish gray-brown and stops bubbling.";;
        char anointStr = "'You have saved us from eternal torment. Our strength is now yours in the battle to come.'";;
        char piranhaDeathStr = "You are swarmed by a school of vicious piranhas and torn to shreds.";;
        char jostleStr = "You jostle each other and tumble into the water.";;
                                            ...
                                            protected override void FnEvent08(TwPlayerServer player, MapEventType type, bool doMsgs) {
                                                ...
                                                protected override void FnEvent15(TwPlayerServer player, MapEventType type, bool doMsgs) {
                                                    ...
                                                    protected override void FnEvent16(TwPlayerServer player, MapEventType type, bool doMsgs) {
                                                        register;
                                                        ubyte bootyFlag;
                                                        ubyte booty1 = 0;ubyte booty1;ubyte booty2 = 0;ubyte booty2;ubyte booty3 = 0;;
