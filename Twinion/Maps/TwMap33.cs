namespace XPT.Twinion.Maps {
    class TwMap33 : TwMap {
        ...
        char aStr = "ANOMIE";;
        char bStr = "BEWILDERMENT";;
        char cStr = "CONFUSION";;
        char dStr = "DESPAIR";;
        char eStr = "ENNUI";;
        char fStr = "FATALISM";;
        char gStr = "GRIEF";;
        char hStr = "HOPELESSNESS";;
        char menageDescDefault = "There is a pile of moldering bones here, bound by rusty chains.";;
        char menageDescPrisoner = "A wild-eyed, delirious prisoner is slumped in the corner, confined by a glowing neck-manacle.";;
        char menageRescueThanks = "The prisoner rises, bows deeply, and thanks you.";;
        char menageTwistyClue = "'I am Shelia, erstwhile architect to His Madness. I was ordered to design the chambers of this maze to be indistinguishable. But a number of them have unique features. As for the rest, perhaps a clever party could mark them also...'";;
        char menageDoorsClue = "'I am Gravus, a Master Puzzlemaker. I created the traps here. The Puzzlers' Code prohibits divulging solutions, but listen: At least one door speaks the truth, and at least one lies. But first you must raise The Tower.";;
        char menageAlchemyClue = "'Choronzar has been performing alchemical experiments using the precious metals. If you can complete these experiments perhaps they will help you defeat him.'";;
        char menageBottleClue = "'I was taken with my lady Naomi from her chamber room on the very eve of her wedding. Twas awful! Now Choronzar's stolen her spirit and locked it in a bottle so we can never leave! One of the other prisoners told me it was tossed into The Vortex.'";;
        char menageWeird1 = "'... it's a ramshonkle junkycam ...'";;
        char menageWeird2 = "'... flowing with and curling in ... it doesn't make any go ...'";;
        char menageWeird3 = "'... she was a beautiful lad ...'";;
        char menageWeird4 = "'... the three-eyed man in the kingdom of the blind ... ' the brabham and the braugham ...'";;
        char menageWeird5 = "'... giant meteor, KILL ME NOW ...'";;
        char menageWeird6 = "'... a godzillion ... killyajolts ... a hundred jillion killyazolts ... '";;
        char menageWeird7 = "'... is points-of-light happy? .... no, points-of-light is not happy ...'";;
        char door1Str = "The middle door does not lead to the maze.";;
        char door2Str = "I do not lead to the maze.";;
        char door3Str = "'I lead to the maze.'";;
        char redHerring = "Pushing the BIG RED BUTTON opens the door to the Easter Egg.";;
        char majorDomo1 = "As you step through the archway a bald, portly, little man in coat and tails hails you. 'Greetings', he beams, 'and welcome to the Halfway House! I am the Major Domo.'";;
        char majorDomo2 = "The Major Domo falls into step with you. 'You look tired,' he observes, 'but you've come the right place!' He pauses to blot at his brow with a flannel kerchief. 'The pools will have you feeling right in a jiffy!'";;
        char majorDomo3 = "The Major Domo continues: 'You mustn't give up, you know. A real adventurer NEVER gives up. Surrender is expressly forbidden by the Hero's Creed and reflects very poorly upon one's ancestry.'";;
        char majorDomo4 = "'And besides, you're halfway there! That's why we call this place the Halfway House, after all.  It's all downhill from here!'";;
        char majorDomo5 = "The Major Domo prattles on: 'So take your time, catch your breath, and steel yourself for the glorious battles to come. Farewell!'";;
                ...
                switch (HERE()) {
                    ...
                    case 252:
                        case 253:
                            case 254:
                                case 255:
                                    TELEPORT(player, type, doMsgs, 13, 2, HERE(),  - , 1, WEST);
                                    break;
                            }
                        }
                        ...
                        protected override void FnEvent05(TwPlayerServer player, MapEventType type, bool doMsgs) {
                            ...
                            if (FLAG_OFF(player, type, doMsgs, PARTY, CAROUSEL_CTRL)) {
                                ...
                                protected override void FnEvent11(TwPlayerServer player, MapEventType type, bool doMsgs) {
                                    register;
                                    ushort switchFlag;
                                    ushort destSquareushort destSquare;ushort destFacing;
                                    switchFlag = HERE();
                                    switchFlag <  <= 8;
                                    switchFlag +  = FACING();
                                    switch (switchFlag) {
                                                            ...
                                                            protected override void FnEvent1B(TwPlayerServer player, MapEventType type, bool doMsgs) {
                                                                ...
                                                                protected override void FnEvent1D(TwPlayerServer player, MapEventType type, bool doMsgs) {
                                                                    ...
                                                                    if (USED_ITEM(player, type, doMsgs, BRASSRING, BRASSRING)) {
                                                                        ...
                                                                        HIDE_WALL(player, type, doMsgs, HERE(), WEST);
                                                                ...
                                                                protected override void FnEvent1E(TwPlayerServer player, MapEventType type, bool doMsgs) {
                                                                    ...
                                                                    ubyte targFlag;
                                                                    ubyte thisFlagOff;
                                                                    ubyte targFlagOff = 100;;
                                                                    ubyte thisBits = 0;ubyte x01ubyte x01;ubyte thatBits = 0;ubyte x01;
                                                                    ushort switchFlag;
                                                                    switchFlag = HERE();
                                                                    switch (switchFlag) {
                                                                        case 214:
                                                                    ...
                                                                    if (USED_ITEM(player, type, doMsgs, FUNHOUSEKEY, FUNHOUSEKEY)) {
                                                                        ...
                                                                        if (targFlagOff != 100) {
                                                                            ...
                                                                            thisFlag |  = 0;
                                                                            x8;
                                                                            while !(thisFlag & thisBits)thisBits <  <= 1;
                                                                            thisFlag &  = 0;
                                                                            x07;
                                                                            thisBits &  = 0;
                                                                            x07;
                                                                            targFlag |  = 0;
                                                                            x8;
                                                                            while !(targFlag & thatBits)thatBits <  <= 1;
                                                                            targFlag &  = 0;
                                                                            x07;
                                                                            thatBits &  = 0;
                                                                            x07;
                                                                                                                                                                            ...
                                                                                                                                                                            case 8:
                                                                                                                                                                                case 29:
                                                                                                                                                                                    ...
                                                                                                                                                                                    protected override void FnEvent27(TwPlayerServer player, MapEventType type, bool doMsgs) {
                                                                                                                                                                                        ...
                                                                                                                                                                                        ushort i;
                                                                                                                                                                                        ubyte treasure;
                                                                                                                                                                                        ubyte squareubyte square;ubyte facing;
                                                                                                                                                                                        NO_MAPS();
                                                                                                                                                                                        ...
                                                                                                                                                                                        switch (flag % 9) {
                                                                                                                                                                                            ...
                                                                                                                                                                                            for (i = 1; i <= (PARTY_COUNT() + 1); i++) {
                                                                                                                                                                                                GET_MONSTER(player, type, doMsgs, i, MONST_VORTEX_1,  + , flag);
                                                                                                                                                                                            }
                                                                                                                                                                                        }
                                                                                                                                                                                        protected override void FnEvent28(TwPlayerServer player, MapEventType type, bool doMsgs) {
                                                                                                                                                                                            char *strPtr1 = NULL;char *strPtr1;char *strPtr2 = NULL;;
