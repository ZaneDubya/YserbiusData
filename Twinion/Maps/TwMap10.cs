...
namespace XPT.Twinion.Maps {
    class TwMap10 : TwMap {
        ...
        protected override void FnEvent01(TwPlayerServer player, MapEventType type, bool doMsgs) {
            int flags = 0;
            flags = GET_FLAG(player, type, doMsgs, DUNGEON, ARMORY_ITEM) + GET_FLAG(player, type, doMsgs, DUNGEON, JACKET);
        ...
        protected override void FnEvent1A(TwPlayerServer player, MapEventType type, bool doMsgs) {
            if (HAS_ITEM(player, type, doMsgs, SPIDERSILKHELM)) {
                ...
                SET_PM(player, type, doMsgs, POISON, 5, MAX_HEALTH(player, type, doMsgs) / 2);
        ...
        protected override void FnEvent2E(TwPlayerServer player, MapEventType type, bool doMsgs) {
            ...
            else if (GUILD(player, type, doMsgs) == CLERIC || GUILD(player, type, doMsgs) == RANGER) {
