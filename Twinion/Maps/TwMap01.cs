...
namespace XPT.Twinion.Maps {
    class TwMap01 : TwMap {
        ...
        protected override void FnEvent0D(TwPlayerServer player, MapEventType type, bool doMsgs) {
            ...
            SET_FLAG(player, type, doMsgs, PARTY, BATSCAVE, HERE(player, type, doMsgs));
        }
        ...
        protected override void FnEvent12(TwPlayerServer player, MapEventType type, bool doMsgs) {
            ...
            protected override void FnEvent13(TwPlayerServer player, MapEventType type, bool doMsgs) {
                if ((GET_FLAG(player, type, doMsgs, DUNGEON, THIEFBOOTY) == 0) || GET_FLAG(player, type, doMsgs, DUNGEON, THIEFBOOTY) != 2 && GET_FLAG(player, type, doMsgs, DUNGEON, THIEFBOOTY) != HERE(player, type, doMsgs)) {
                    ...
                    if (GET_FLAG(player, type, doMsgs, DUNGEON, THIEFBOOTY) == 230) {
                        ...
                        SET_FLAG(player, type, doMsgs, DUNGEON, THIEFBOOTY, HERE(player, type, doMsgs));
                    }
                }
                else {
                    SHOW_TEXT(player, type, doMsgs, "There's nothing more here.");
            ...
            protected override void FnEvent1A(TwPlayerServer player, MapEventType type, bool doMsgs) {
                ...
                HEAL(player, type, doMsgs, HEALTH(player, type, doMsgs));
            }
