...
namespace XPT.Games.Yserbius.Maps {
    class YserMap19 : YsMap {
        ...
        private void FnFOUNBLES_03(YsPlayerServer player, MapEventType type, bool doMsgs) {
            ...
            L0073: ShowMessage(player, doMsgs, String0461); // You find the Fountain of Restoration and sip from it. You feel your Health greatly improve.
            L0080: return; // RETURN;
        }
        ...
        private void FnQUESTENC_04(YsPlayerServer player, MapEventType type, bool doMsgs) {
            ...
            L0034: ShowMessage(player, doMsgs, String04BD); // Monsters attack you.
            L0041: goto L0071;
            L0043: AddTreasure(player, 0x03E8, 0x00, 0x00, 0xA2, 0xD0, 0x81);
            L0064: ShowMessage(player, doMsgs, String04D2); // Among a horde of Nightmares and Cockatrices you spot armor and other items on the floor.
        ...
        private void FnLKPKDORZ_05(YsPlayerServer player, MapEventType type, bool doMsgs) {
            ...
            L0054: ShowMessage(player, doMsgs, String052B); // The door opens easily when you use the Lava Key.
            L0061: goto L008D;
            L0063: SetWallPassable(player, GetCurrentTile(player), GetFacing(player), 0x00);
            L0080: ShowMessage(player, doMsgs, String055C); // This door cannot be unlocked without the Lava Key.
            L008D: return; // RETURN;
        }
        ...
        private void FnSTRDOOR_06(YsPlayerServer player, MapEventType type, bool doMsgs) {
            ...
            L0014: ShowMessage(player, doMsgs, String058F); // You manage to force the door open.
            ...
            L005D: goto L0089;
            L005F: ShowMessage(player, doMsgs, String05B2); // The door is stuck.
        ...
        private void FnNPCCHATA_0E(YsPlayerServer player, MapEventType type, bool doMsgs) {
            ...
            L002F: ShowMessage(player, doMsgs, String05E2); // Find the Fountain of Tranquility if you are battle weary. Find it - if you can.
            L003C: goto L004B;
            L003E: ShowMessage(player, doMsgs, String0632); // The Human Thief cringes in terror and wraps herself up in a tight ball.
            L004B: return; // RETURN;
        }
        ...
        private void FnNPCCHATB_0F(YsPlayerServer player, MapEventType type, bool doMsgs) {
            ...
            L002D: if (JumpAbove) goto L003E;
            L002F: ShowMessage(player, doMsgs, String069A); // A halfling thief told me of a wondrous world of four seasons deep in the heart of the dungeon. Of course, I did not believe him. Thieves are such liars.
            L003C: goto L004B;
            L003E: ShowMessage(player, doMsgs, String0733); // The Elf Barbarian dismisses you as useless baggage and heads off to find true heroes.
            L004B: return; // RETURN;
        }
